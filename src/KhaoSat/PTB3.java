...
public class PTB3 {
	...
	public void VeBangBienThien(Group gr)
	{
        ...
        double ylimit_min = (_a3 * limit_min * limit_min * limit_min + _b3 * limit_min * limit_min + _c3 * limit_min + _d3);
        double ylimit_max = (_a3 * limit_max * limit_max * limit_max + _b3 * limit_max * limit_max + _c3 * limit_max + _d3);
         ...
         if(x1<x2)
         {
        	 if(delta > 0 && _a3>0)
        	 {
        		 //Dien gia tri len khung x
        		  ...
        		  Line line2 = new Line(r1.getX()+155,r1.getY()+55,r1.getX()+250,r1.getY()+r1.getHeight()-10);
        		  
        		  Text t12 = new Text(r1.getX()+250,r1.getY()+r1.getHeight()-20,str_y32);
        		  Line line3 = new Line(r1.getX()+255,r1.getY()+r1.getHeight()-10,r1.getX()+r1.getWidth()-35,r1.getY()+55);
        		...
        		//Dien gia tri len khung y
        		  ...
        		  Line line1 = new Line(r1.getX()+75,r1.getY()+55,r1.getX()+150,r1.getY()+r1.getHeight()-10);
        		  Text t10 = new Text(r1.getX()+150,r1.getY()+r1.getHeight()-20,str_y31);
        		  Line line2 = new Line(r1.getX()+155,r1.getY()+r1.getHeight()-10,r1.getX()+250,r1.getY()+55);
        		  Text t12 = new Text(r1.getX()+250,r1.getY()+55,str_y32);
        		  Line line3 = new Line(r1.getX()+255,r1.getY()+55,r1.getX()+r1.getWidth()-35,r1.getY()+r1.getHeight()-10);
        		  ...
        		  gr.getChildren().addAll(t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13,line1,line2,line3,text11,text12,text13,text14);
        			 ...
        			 if(delta<=0 && _a3>0)
        			 {
        				//Dien gia tri len khung x
                		  ...
                		  Line line1 = new Line(r1.getX()+75,r1.getY()+r1.getHeight()-10,r1.getX()+r1.getWidth()-35,r1.getY()+55);
        				...
        				//Dien gia tri len khung x
               		  ...
               		  Text t7 = new Text(r1.getX()+200,r1.getY()+35,"-");
               		  //Dien gia tri khung y
               		  Line line1 = new Line(r1.getX()+75,r1.getY()+55,r1.getX()+r1.getWidth()-35,r1.getY()+r1.getHeight()-10);
               		  Text t10 = new Text(r1.getX()+150,r1.getY()+90,str_y31);
               		  Text t11 = new Text(r1.getX()+35,r1.getY()+55,"+oo");
...
//                }
    		...
    		setGioiHan("Giới hạn: Khi x tiến đến + oo \n thì lim y = - oo"+"\n Khi x tiến đến - oo \n thì lim y = + oo");
    		if(delta>0)
    		{
                 ...
                 cuctri += "\n Hàm số đạt cực đại tại x = "+x2+" ,yCĐ = "+cucdai;
                 cuctri += "\n Hàm số đạt cực tiểu tạo x = "+x1+" ,yCT = "+cuctieu+'\n';
                 setDiemUon("Phương trình y'' = 0 có nghiệm \n x = " + xdiemuon + " => M(" + xdiemuon + "," + ydiemuon + ") là điểm uốn của đồ thị hàm số đã cho");
                 set_yPhay("Phương trình y' = " +_a3*3 + " .x^2 + " + _b3*2 + ".x + " + _c3+" có 2 nghiệm \n"
             		 	+" x1="+x1+" và x2="+x2);   
    		}
    		else if (delta ==0)
